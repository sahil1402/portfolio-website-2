      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4">
        <nav className="flex items-center justify-between">
          <Link href="/" className="group flex items-center gap-3">
            <div className="relative flex h-9 w-9 items-center justify-center rounded-lg overflow-hidden border border-primary/50 transition-all duration-400 group-hover:border-primary group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-primary/25">
  <img src="/profile-pic.png" alt="Sahil" className="h-full w-full object-cover" />
</div>
