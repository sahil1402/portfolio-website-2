export const themes = {
  blue: {
    name: "Blue",
    light: {
      background: "oklch(0.985 0.002 235)",
      foreground: "oklch(0.12 0.015 235)",
      card: "oklch(1 0 0)",
      "card-foreground": "oklch(0.12 0.015 235)",
      popover: "oklch(1 0 0)",
      "popover-foreground": "oklch(0.12 0.015 235)",
      primary: "oklch(0.55 0.15 235)",
      "primary-foreground": "oklch(0.98 0 0)",
      secondary: "oklch(0.96 0.008 235)",
      "secondary-foreground": "oklch(0.22 0.015 235)",
      muted: "oklch(0.96 0.008 235)",
      "muted-foreground": "oklch(0.48 0.01 235)",
      accent: "oklch(0.55 0.15 235)",
      "accent-foreground": "oklch(0.98 0 0)",
      border: "oklch(0.92 0.008 235)",
      input: "oklch(0.92 0.008 235)",
      ring: "oklch(0.55 0.15 235)",
      "glow-color": "oklch(0.55 0.15 235 / 0.15)",
      "glow-color-strong": "oklch(0.55 0.15 235 / 0.25)",
    },
    dark: {
      background: "oklch(0.06 0.015 235)",
      foreground: "oklch(0.96 0 0)",
      card: "oklch(0.1 0.015 235)",
      "card-foreground": "oklch(0.96 0 0)",
      popover: "oklch(0.1 0.015 235)",
      "popover-foreground": "oklch(0.96 0 0)",
      primary: "oklch(0.70 0.14 235)",
      "primary-foreground": "oklch(0.06 0.015 235)",
      secondary: "oklch(0.16 0.015 235)",
      "secondary-foreground": "oklch(0.88 0 0)",
      muted: "oklch(0.16 0.015 235)",
      "muted-foreground": "oklch(0.58 0 0)",
      accent: "oklch(0.70 0.14 235)",
      "accent-foreground": "oklch(0.06 0.015 235)",
      border: "oklch(0.2 0.015 235)",
      input: "oklch(0.2 0.015 235)",
      ring: "oklch(0.70 0.14 235)",
      "glow-color": "oklch(0.70 0.14 235 / 0.12)",
      "glow-color-strong": "oklch(0.70 0.14 235 / 0.22)",
    },
  },
  golden: {
    name: "Golden",
